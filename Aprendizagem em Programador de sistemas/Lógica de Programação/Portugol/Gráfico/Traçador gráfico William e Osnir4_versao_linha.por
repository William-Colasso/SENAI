	...
	funcao parabola2(){
			se(a>0 e delta>0){
				para(inteiro i = 0; i<99; i+=1){
					g.desenhar_linha((vetor_x[i])+750+(xv*zoom), (-vetor_y[i])+335+(yv*zoom),(vetor_x[i])+750+(xv*zoom), (-vetor_y[i])+335+(yv*zoom))
					g.desenhar_linha(-(vetor_x[i])+750+(xv*zoom), (-vetor_y[i])+335+(yv*zoom),(-vetor_x[i+1])+750+(xv*zoom), (-vetor_y[i+1])+335+(yv*zoom))
				}
			}
			se(a<0 e delta>0){
				para(inteiro i = 0; i<99; i+=1){
