...
public class ProdutoDaoImpl implements ProdutoDao {
    ...
    public Produto getProduto(int codigo) {
        ...
        try {
            ...
            if (resultSet.next()) {
                produto = new Produto(resultSet.getInt("codigo"), resultSet.getString("descricao"), resultSet.getString("unidade"), resultSet.getFloat("qtd"), resultSet.getFloat("preco"));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public List<Produto> getAllProdutos() {
        ...
        try {
            ...
            while (resultSet.next()) {
                produtos.add(new Produto(resultSet.getInt("codigo"), resultSet.getString("descricao"), resultSet.getString("unidade"), resultSet.getFloat("qtd"), resultSet.getFloat("preco")));
            }
    ...
    public void updateProduto(Produto produto) {
        try {
            String query = "UPDATE Produto SET descricao = ?, unidade = ?, qtd = ?, preco = ? WHERE codigo = ?";
